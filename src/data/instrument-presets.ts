...
export const INSTRUMENTS: Record<string, InstrumentPreset> = {
  ...
  'electric guitar': {
    ...
    harmonics: [
      ...
      { harmonic: 6, gain: 0.04, role: '6th Harmonic (H6)', decay: 0.3 },
    ],
    envelope: { attack: 0.003, decay: 0.8, sustain: 0.12, release: 0.4 },
    filter: { type: 'lowpass', frequency: 4500, Q: 0.7 },
    filterEnvelope: { amount: 2500, attack: 0.003, decay: 0.4 },
    percussive: true,
    unison: { voices: 2, detune: 4 },
    noise: {
      noiseFilterFreq: 6000, noiseFilterQ: 1.0, noiseFilterType: 'bandpass',
      gain: 0.10, role: 'Pick Transient',
      attack: 0.001, decay: 0.015, sustain: 0, release: 0.01,
    },
    octave: 3,
    waveShape: 'sawtooth',
    description: 'Sawtooth fundamental models the rich pickup tone of an electric guitar. Higher filter cutoff than acoustic (4500Hz) reflects how pickups capture full string vibration. 2-voice unison at 4 cents adds slight chorus for pickup width simulation. Pick noise at 6kHz for bright transient.',
  },
};
// @ts-nocheck
// Alias map for fuzzy instrument name matching
export const ALIASES = {
  ...
  clarnet: 'clarinet', clar: 'clarinet', clari: 'clarinet',
  obo: 'oboe', hautbois: 'oboe',
  bassoon: 'bassoon', fagot: 'bassoon', fagotto: 'bassoon',
  violen: 'violin', fiddle: 'violin', viol: 'violin',
  viola: 'viola', cello: 'cello', violoncello: 'cello', violincello: 'cello',
  bass: 'double bass', contrabass: 'double bass', stringbass: 'double bass',
  gtr: 'guitar', guiter: 'guitar', geeetar: 'guitar',
  piano: 'piano', pianao: 'piano', keys: 'piano', keyboard: 'piano',
  orgn: 'organ', pipeorgan: 'organ',
  synth: 'synth pad', synthesizer: 'synth pad', pad: 'synth pad',
