// @ts-nocheck
// TypeScript port of llmClient.js
...
interface Settings { endpoint: string; apiKey: string; model: string; }
...
export async function generateInstrument(query: string): Promise<{ layers: any[]; description: string }> {
  if (!query || !query.trim()) {
